...
?>
            <!--li class="col-md-<?php //echo $span; ?> hikashop_category hikashop_category_column_<?php //echo $current_column; ?> hikashop_category_row_<?php //echo $current_row; ?>"-->
			<div class="col-md-<?php echo $span; ?> hikashop_category_column_<?php echo $current_column; ?> hikashop_category_row_<?php echo $current_row; ?>">
				<div class="hikashop_container">
					<div class="hikashop_subcontainer <?php echo $borderClass; ?>">
<?php
			}
