...
if($carouselEffect=='slide'){
	if($direction=='horizontal'){
        ?> <div class="carousel slide"> <?php
		//if($this->params->get('display_button')) echo '<a id="hikashop_previous_button_'.$mainDivName.'" class="left carousel-control"><img class="hikashop_slider_button" src="'.HIKASHOP_IMAGES.'icons/prev.png" alt="hikashop_previous_button_'.$mainDivName.'" /></a>';
		if($this->params->get('div_item_layout_type')=='fade' || $this->params->get('div_item_layout_type')=='slider_vertical' || $this->params->get('div_item_layout_type')=='slider_horizontal' || $this->params->get('div_item_layout_type')=='img_pane'){
			echo '<div id="hikashop_main_slider_'.$mainDivName.'" class="col carousel-inner hikashop_main_carousel_div hikashop_subcontainer '.$borderClass.'" style="padding-bottom:0px; padding-top:0px; margin: auto; overflow:hidden;   height:'.$heightCat.'px;">';
...
if ($this->params->get('display_button') && $direction == 'horizontal'):?>
    <a id="hikashop_previous_button_<?php echo $mainDivName; ?>" class="left carousel-control">
        <span class="glyphicon glyphicon-chevron-left"></span>
    </a>
    <a id="hikashop_next_button_<?php echo $mainDivName;?>" class="right carousel-control">
        <span class="glyphicon glyphicon-chevron-right"></span>
    </a>
<?php elseif($this->params->get('display_button') && $direction=='vertical') :?>
            </th>
        </tr><tr>
            <th style="text-align:center;">
                <a id="hikashop_next_button_<?php echo $mainDivName;?>">
                    <img class="hikashop_slider_button" src="<?php echo HIKASHOP_IMAGES;?>icons/down.png" alt="down" />
                </a>
            </th>
        </tr>
    </table>
