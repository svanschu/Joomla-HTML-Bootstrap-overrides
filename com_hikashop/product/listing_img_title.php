...
if ($this->config->get('thumbnail', 1)) {
    ...
    <div style="text-align:center;clear:both;" class="hikashop_product_image">
        <div
            style="position:relative;text-align:center;clear:both;width:<?php echo $this->image->main_thumbnail_x; ?>px;margin: auto;"
...
<?php } ?>
    ...
    <div class="rosenschule_product_nmaeprice">
        <div class="rosenschule_product_name">
        <!-- PRODUCT NAME -->
    ...
    <!-- PRODUCT PRICE -->
<div class="rosenschule_product_price">
<?php
...
if (JRequest::getVar('hikashop_front_end_main', 0) && JRequest::getVar('task') == 'listing' && $this->params->get('show_compare')) {
    ...
    <!-- EO COMPARISON AREA -->
<?php if (!empty($this->row->extraData->bottom)) {
